...
{
    public static final List<NewDungeon> DUNGEONS = new ArrayList<>();
    ...
    public static NewDungeon create(Location location, MessageReceivedEvent event, PlayerDataQuery leader, List<PlayerDataQuery> others)
    {
        NewDungeon d = new NewDungeon();
    ...
    public void win()
    {
        ...
        NewDungeon.delete(this.leader.data.getID());
    }
    ...
    {
        return NewDungeon.instance(ID) != null;
    }

    public static NewDungeon instance(String ID)
    {
